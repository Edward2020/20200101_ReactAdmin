...
const BASE='/api'
// 登陆
export const reqLogin = (username, password) => ajax(BASE+'/login', {username, password},
    'POST')
...
// 获取商品分页列表
export const reqProducts = (pageNum, pageSize) => ajax(BASE+'/manage/product/list', {pageNum,
    pageSize})
...
// 添加/更新商品
export const reqAddOrUpdateProduct = (product) => ajax(BASE+'/manage/product/' +
...
// 添加/更新用户
export const reqAddOrUpdateUser = (user) => ajax(BASE+'/manage/user/'+(user._id ? 'update' :
    'add'), user, 'POST')
// 获取用户列表
